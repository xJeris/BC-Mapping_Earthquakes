...
// ********** Deliverable 3: Add a 3rd map type **********
// We create the second tile layer that will be the background of our map.
...
function mstyleInfo(feature) {
  return {
    opacity: 1,
    fillOpacity: 1,
    fillColor: mgetColor(feature.properties.mag),
    color: "#000000",
    radius: mgetRadius(feature.properties.mag),
    stroke: true,
    weight: 0.5
  };
}
